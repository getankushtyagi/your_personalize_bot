      ...
      <div className="relative z-10">
        ...
        >
          <img
            ...
            alt="PGMind&#0046;ai - Build&#0032;a&#0032;ChatGPT&#0032;plugin&#0032;in&#0032;minutes | Product Hunt"
            style={{
              width: '250px',
              height: '54px',
              marginLeft: 'auto',
          ...
          />
              ...
              <Stack gap={1}>
                ...
                <Typography textColor="text.secondary">
                  <span style={{ display: "flex" }}>
                    <Image src="/sb_logo.jpeg" width="30" height="100" alt='Made by Squareboat' style={{ marginRight: "0.5rem" }} />
                    <b style={{ paddingTop: "4px" }}>Squareboat</b>
                  </span>
                  {/* <b>+3.5K</b> companies have successfully <br></br>built their
                  custom AI Agent with PGMind.ai */}
                </Typography>
              </Stack>
            </Box>
            ...
            <Stack
              ...
              className="justify-center sm:justify-start"
            >
              <Link target="_blank" href={`${process.env.NEXT_PUBLIC_APP_URL}signin`}>
                <Button
                  variant="solid"
                  size="lg"
              ...
              <Link
                target="_blank"
                href={'https://calendly.com/puru-tja/30min'}
              >
                <Button
                  variant="outlined"
                  size="lg"
          ...
          <div className="w-full sm:w-2/3">
            <Image src="/landing-page/inputs.png" width="500" height="150" className='w-full' alt='landing-page' />
            <div className='w-full h-[500px] overflow-hidden rounded-3xl bg-white'>
              <iframe
                src="https://pgmind.squareboat.info/agents/cllq3nxuh0002w5ix053dcvqy/iframe"
                width="100%"
                height="100%"
                border="0"
              ></iframe>
            </div>
            {/* <Image src="/landing-page/outputs.png" width="500" height="150" className='w-full' alt='bottom img'/> */}
          </div>
        </div>

        <div className="flex justify-center mt-10 gap-x-6">
          {/* <Button target="_blank" href={`${process.env.NEXT_PUBLIC_APP_URL}signin`}>Start Building</Button> */}
          {/* <Button

        ...
        <nav className="relative z-50 flex justify-between">
          <div className="flex items-center md:gap-x-12">
            ...
            <div className="hidden md:flex md:gap-x-6">
              ...
              {/* this is used for solution in header */}
              {/* <Menu /> */}
          ...
          <div className="flex items-center gap-x-5 md:gap-x-8">
            {/* <div className="hidden md:block">
              <NavLink href={process.env.NEXT_PUBLIC_APP_URL}>Sign in</NavLink>
            </div> */}
            {/* <Button target="_blank" href={`${process.env.NEXT_PUBLIC_APP_URL}signin`} color="blue">
              <span>
                Sign In
              </span>
            </Button> */}
            {/* Change following link href with /signin for local signin */}
            <Link href={`${process.env.NEXT_PUBLIC_APP_URL}signin`}>

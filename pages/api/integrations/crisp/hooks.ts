...
const handleQuery = async (
  ...
  await CrispClient.website.sendMessageInConversation(websiteId, sessionId, {
    ...
    user: {
      type: 'participant',
      nickname: agent?.name || 'PGMind.ai',
      avatar: agent.iconUrl || `${process.env.NEXT_PUBLIC_APP_URL}app-rounded-bg-white.png`,
    },
  });

      ...
      <Box mb={4}>
        <UserFree>
          <Card variant="outlined" sx={{ bgcolor: 'black' }}>
            ...
            <stripe-pricing-table pricing-table-id="prctbl_1NkKGxSDMKn0SG7T4piILwtl"
              publishable-key="pk_test_51NTNo5SDMKn0SG7T5aosVImSsx1tMshCvMYDmDHGA47eAlNtuZVBvnqWwXNujLQS3LWQ0WFnsFqMBk5NuHBX6q4M00r8CnKKQI"
      ...
      >
        <FormControl id="plan" sx={{ gap: 1 }}>
          ...
          {/* <Typography level="body3">
            Use the api key to access the PGMind API
          </Typography> */}
        ...
        {/* <Box id="api-keys">
          <FormControl sx={{ gap: 1 }}>
            ...
            <Stack direction={'column'} gap={2} mt={2}>
              ...
              >
                Learn more about the PGMind API
              </Alert>

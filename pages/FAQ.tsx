const faqs = [
  ...
  },
  {
    ...
    answer:
      'The content of the document is hosted on secure servers in India. If you want to host on your infrastructure, please write an email to puru@pgmind.com',
  },
  {
    id: 4,
    question: 'Does it support other languages?',
    answer:
      'Yes, PGMind supports about 90 languages. You can have your sources in any language and ask it questions in any language.',
  },
  {
    id: 5,

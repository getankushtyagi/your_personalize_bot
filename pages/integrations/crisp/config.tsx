...
export default function CrispConfig(props: { agent: Agent }) {
  ...
  return (
    <>
      <Head>
        <title>PGMind - LLMs automation without code</title>
        <meta
          name="description"
          ...
          <Card variant="outlined">
            ...
            <form className="flex flex-col">
              <Stack spacing={2}>
                {!user && (
                  <FormControl>
                    <FormLabel>PGMind API Key</FormLabel>
                    <Alert variant="outlined" sx={{ mb: 2 }}>
                      <Stack>
                        You can find your API Key in your PGMind{' '}
                        <Link
                    ...
                    <Input
                      value={inputValue}
                      placeholder="Your PGMind API Key here"

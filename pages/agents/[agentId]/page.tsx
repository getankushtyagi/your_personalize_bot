  ...
  return (
    <>
      <Head>
        ...
        <title>{`${props?.agent?.name} - made with PGMind.ai`}</title>

        <meta
          name="title"
          content={`${props?.agent?.name} - made with PGMind.ai`}
        />
        <meta name="description" content={`${props?.agent?.description}`} />
        <meta
          name="keywords"
          content="AI chatbot, No-code platform, Customer support, Onboarding, Slack AI chatbot, Automation, PGMind, ChatGPT Plugin"
        />
        <meta
          property="og:title"
          content={`${props?.agent?.name} - made with PGMind.ai`}
        ...
        <meta
          property="og:url"
          content={`${process.env.NEXT_PUBLIC_APP_URL}@${props?.agent?.handle}`}
        />
